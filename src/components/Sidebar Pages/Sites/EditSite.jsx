...
//   useEffect(() => {
//     const currentSite = storeAllQuotation.find((site) => site._id === quotationId);
...
//         setloading(false);
//         dispatch(updateQuotations(response.data.existingsite));
...
//         `${serverUrl}/api/sites/${quotationId}/edit-site`,
//         newsite,
//         {
//           headers: {
...
//         dispatch(updateQuotations(response.data.updatedsite));
