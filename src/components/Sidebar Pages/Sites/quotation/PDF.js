...
export const generatePDF = async (currentQuotation) => {
    ...
    try {
      ...
      pdfContent.className = 'bg-gradient-to-r from-gray-100 to-gray-50 max-w-5xl mx-auto p-8 shadow-2xl rounded-lg border border-blue-200'; // Adjusted width here
          ...
          <table class="table-auto w-full bg-gray-50 border-collapse">
            <thead>
              <tr class="bg-rose-200 text-black no-page-break">
                <th class="px-2 py-2">Thumbnail</th>
                  ...
                  (item) => `
                    <tr class="bg-white border-b border-gray-200 no-page-break">
                      <td class="border px-4 py-2">
                        <img src="${item.thumbnailImage}" alt="Item Thumbnail" class="w-12 h-12 rounded-lg shadow-md" />
                      </td>
