    ...
    <>
      <div>
        ...
        <div>
          ...
          <div className="grid grid-cols-4 md:grid-cols-7 bg-gray-50 text-center my-4 p-2">
            <h2 className="px-6 col-span-2 text-md font-bold tracking-wider">
              Business
            </h2>
            <h2 className="px-2 col-span-1 text-md font-bold">
              Quotation Date
            </h2>
            <h2 className="px-2 col-span-1 md:block hidden text-md font-bold"></h2>
        ...
        {storeAllQuotations && storeAllQuotations?.length > 0 ? (
          storeAllQuotations?.map((site, index) => {
            ...
            return (
              <div
                key={index}
                className="px-8 py-4 shadow-lg border border-t-2 my-2 rounded-md grid grid-cols-5 md:grid-cols-7 text-center"
              >
                <Link
                  to={`/Admin/siteInfo/${site?._id}`}
                  className="underline text-blue-500 text-sm px-2 font-medium col-span-2 row-span-2 flex items-center justify-between"
                >
