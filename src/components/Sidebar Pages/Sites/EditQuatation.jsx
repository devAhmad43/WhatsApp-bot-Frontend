  ...
  const handleFormSubmit = async () => {
    ...
    try {
      ...
      if (attachment instanceof File) {
        ...
        updatedQuotation.descriptionField["attachment"] =
      ...
      if (clientImage instanceof File) {
        ...
        updatedQuotation.client["businessImage"] = await uploadtoCloudinary(
                  ...
                  <div className="mt-6 space-y-2">
                    ...
                    <div className="flex flex-col mt-4 space-y-4">
                      ...
                      <div className="flex justify-between">
                        ...
                        <h2 className="ml-2 font-light text-sm border-b border-1 border-gray-300">
